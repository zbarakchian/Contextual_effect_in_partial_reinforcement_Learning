function plot_figure_contextual_effect6conf(addr,config_main,ftype,sbjs,model,colors,transfer_greedy)
...
%--------------------------------------------------------------------------
x = [1:6];
y{1}  = [real.conf_left_mean(1), real.conf_right_mean(1)]; %A1A2
y{2}  = [real.conf_left_mean(2), real.conf_right_mean(2)]; %A1B
y{3}  = [real.conf_left_mean(3), real.conf_right_mean(3)]; %A1C
y{4}  = [real.conf_left_mean(4), real.conf_right_mean(4)]; %A2B
y{5}  = [real.conf_left_mean(5), real.conf_right_mean(5)]; %A2C
y{6}  = [real.conf_left_mean(6), real.conf_right_mean(6)]; %BC
