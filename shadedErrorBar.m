...
function H = makePlot(x,y,errBar,lineProps,transparent,patchSaturation)
    ...
    edgeColor=mainLineColor+(1-mainLineColor)*0.85;%85

    mainLineStyle=get(H.mainLine,'LineStyle');
    edgeLineStyle=mainLineStyle;

    mainLineWidth=get(H.mainLine,'LineWidth');
    edgeLineWidth=mainLineWidth*1.5;
    ...
    H.edge(1)=plot(x,lE,edgeLineStyle,'color',edgeColor,'LineWidth',edgeLineWidth);
    H.edge(2)=plot(x,uE,edgeLineStyle,'color',edgeColor,'LineWidth',edgeLineWidth);
